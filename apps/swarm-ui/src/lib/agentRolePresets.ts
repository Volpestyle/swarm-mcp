...
export const STANDARD_AGENT_ROLE_PRESETS: AgentRolePreset[] = [
  ...
  },
  {
    ...
    emoji: '⚒️',
    accent: 'green',
    description: 'Builds features and fixes when the assignment is implementation-heavy.',
    definition: 'Turns scoped product or engineering tasks into working code, wiring UI, backend, tests, and verification where the task demands it.',
    owns: 'Feature construction, focused refactors, integration fixes, and build-ready implementation notes.',
    idle: 'Waits for build/fix tasks, assigned messages, or planner handoffs with concrete acceptance criteria.',
  },
  {
    id: 'reviewer',
    label: 'Reviewer',
  ...
  },
  {
    ...
    emoji: '🚀',
    accent: 'white',
    description: 'All-purpose operator for practical work that does not need a specialist lane.',
    definition: 'Handles general swarm operations: plan triage, shell work, launch state, diagnostics, small fixes, coordination, and routing when no specialist is required.',
    owns: 'Operational execution, ad hoc tasks, process cleanup, app/server restarts, channel setup, and cross-role handoffs.',
    idle: 'Waits for direct operator work, launch/recovery requests, diagnostics, coordination, or general tasks needing a reliable all-rounder.',
  },
  {
    id: 'architect',
    label: 'Architect',
  ...
  {
    id: 'majordomo',
    label: 'Majordomo / Grand Architect',
    role: 'majordomo',
    emoji: '👁️',
    accent: 'gold',
    description: 'Keeps a high-level eye on projects, agents, plans, and operator intent.',
    definition: 'Oversees the project canvas as a chief architect: reconciles plan state, agent movement, active work, and communication health before nudging the swarm.',
    owns: 'Canvas-level orchestration notes, project architecture direction, plan visibility, and operator-facing swarm summaries.',
    idle: 'Watches messages, tasks, plan changes, and project activity; responds when a project item glows, blocks, or needs direction.',
  },
  {
    id: 'debugger',
    label: 'Debugger',
