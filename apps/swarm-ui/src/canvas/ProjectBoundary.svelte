...
<style>
  .project-boundary {
    ...
    pointer-events: none;
	    border: 3px solid color-mix(in srgb, var(--project-border, #ffffff) 86%, rgba(255, 255, 255, 0.42));
    border-radius: 22px;
    background:
      radial-gradient(circle, color-mix(in srgb, var(--project-color, #ffffff) 74%, transparent) 0 1.25px, transparent 1.65px),
      linear-gradient(135deg, color-mix(in srgb, var(--project-color, #ffffff) 12%, rgba(255, 255, 255, 0.06)), rgba(255, 255, 255, 0.025) 42%, rgba(255, 255, 255, 0.01)),
      color-mix(in srgb, var(--project-color, #ffffff) 5%, transparent);
    background-size: 28px 28px, auto, auto;
    box-shadow:
	      0 0 0 2px color-mix(in srgb, var(--project-color, #ffffff) 32%, transparent) inset,
	      0 0 44px color-mix(in srgb, var(--project-color, #ffffff) 68%, transparent),
	      0 0 132px color-mix(in srgb, var(--project-color, #ffffff) 34%, transparent),
	      inset 0 0 94px color-mix(in srgb, var(--project-color, #ffffff) 10%, transparent);
    backdrop-filter: blur(18px) saturate(1.08);
    -webkit-backdrop-filter: blur(18px) saturate(1.08);
    transition: border-color 0.12s ease, box-shadow 0.12s ease, background 0.12s ease, border-radius 0.12s ease;
  }
  ...
  .project-boundary.active {
    ...
    box-shadow:
      ...
      0 0 42px color-mix(in srgb, var(--project-color, #ffffff) 76%, transparent),
      0 0 132px color-mix(in srgb, var(--project-color, #ffffff) 42%, transparent),
      inset 0 0 110px color-mix(in srgb, var(--project-color, #ffffff) 12%, transparent);
  }
  ...
  .project-boundary:has(.project-resize-handle.hot) {
    box-shadow:
      ...
      0 0 48px color-mix(in srgb, var(--project-color, #ffffff) 84%, transparent),
      0 0 150px color-mix(in srgb, var(--project-color, #ffffff) 46%, transparent);
  }
