...
Run the matching command below via your shell tool, then reply with a compact
summary (no narration about how you ran it). Show counts first, then the first
few rows.
...
`integrations/codex/plugins/swarm/README.md` and stop.
