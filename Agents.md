...
## Shared learning and product memory

Before planning or changing swarm-ui product behavior, visual QA, Majordomo,
canvas notes, proof packs, session closeout, or app testability, read these
...
The recommended Obsidian vault root for this shared learning is:

```text
/Users/mathewfrazier/Desktop/9889-new-times/workspace
```

Treat `Experiental Learning Evolution/` as shared product memory for humans,
Majordomo, and all agents. It is not private scratch. If the operator reports a
bad area of the app, preserve the exact complaint, link any area capture or
visual atlas screenshot, and convert the learning into a concrete follow-up
item.
